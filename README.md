...
<h1>THEORY:</h1><BR>
 ...
 <img src="A3.png"   width="800" height="600"><BR>
   <h3> Here is a diagram visualising the results of the network in different ways..</h3><BR>
  
   <img src="A4.png"   width="800" height="600"><BR>
   <h3>This chart depicts how good the network is, with respect to the metrics described above.</h3><BR>
  
   <img src="A5.png"  width="800" height="600"><BR>
   <h3>This bar chart is a final representation of the results, and  confirms how many cases were diagnosed, and with which label.</h3><BR>
  
   <img src="A6.png"  width="800" height="600"><BR>
